...
const ProjectRecallModal: React.FC<ProjectRecallModalProps> = (props) => {
    ...
    const { data: shareDetailData = [], run: getShareDetailData } = useRequest(() => getHasShareDetailData(projectId), { manual: true })
    ...
    return (
        <Modal title="撤回共享" width={750} visible={state as boolean} destroyOnClose
            footer={[
            ...
            ]} onOk={() => recallEvent()} onCancel={() => setState(false)}
        >
