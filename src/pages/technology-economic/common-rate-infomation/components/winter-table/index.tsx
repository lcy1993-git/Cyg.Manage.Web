      ...
      <table className={commonLess.table}>
        ...
        <tbody>
          ...
          <tr>
            <td>II</td>
            <td>
              北京、天津、山东、河南、河北（张家口、承德以南地区）、重
              庆、四川（甘孜、阿坝州除外）、云南（迪庆州除外）、贵州
            </td>
          </tr>
          <tr>
            <td>III</td>
            <td>
              辽宁（盖县及以南地区）、陕西（不含榆林地区）、山西、河北 （张家口、承德及以北地区）
            </td>
          </tr>
          <tr>
            <td>IV</td>
            <td>
              辽宁（盖县以北）、陕西（榆林地区）、内蒙古（锡林郭勒盟锡
              林浩特市以南各盟、市、旗，不含阿拉善盟）、新疆（伊犁、哈密
              地区以南）、吉林、甘肃、宁夏、四川（甘孜、阿坝州）、云南（迪 庆州）
            </td>
          </tr>
          <tr>
            <td>V</td>
