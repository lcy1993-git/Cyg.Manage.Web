  ...
  return (
    <div className={styles.topographicIncreaseFactor}>
      ...
      <div>
        ...
        <p>
          {' '}
          (2) 丘陵: 指陆地上起伏缓和、连绵不断的矮岗、土丘、水平距离1km以内,起伏在50m以下的地带。
        </p>
        ...
        <p>
          {' '}
          (1)
          编制预算是,工程地形按全线的不同地形划分为若干区段,分别以其工程量所占长度的百分比进行计算。
        </p>
        <p> (2) 在确定运输地形是,应按运输路径的实际地形来划分。</p>
        <p>
          {' '}
          (3)
          西北高原台地沿线路平台长度2km以内的工程地形按'山地'论,工地运输地形则按运输路径的实际情况而定,上台运输按'山地'论,台上运输按'平地'论。
        </p>
        <p> (4) 城市市区参考丘陵地形计算。</p>
      </div>
    </div>
