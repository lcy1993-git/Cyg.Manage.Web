...
import type { InterActionRef, MapRef, SetState, SourceRef } from './../typings/index'
...
export default function mapClick(
  ...
  { sourceRef, interActionRef, mapRef, setState }: Ops
) {
  // 设置当前坐标
  ...
  // 获取被选中的元素
  const feature = mapRef.map.getFeaturesAtPixel(e.pixel)
  // console.log(feature);
}
