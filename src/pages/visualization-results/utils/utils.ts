  ...
  updateLabelControlValue(showAllLabel: boolean) {
    ...
    if (!showAllLabel) {
      ...
      // 水平拉线
        ...
        // 设置样式
        this.zero_guys[targetBottomIndex].setStyle(
          zero_guy_style(this.zero_guys[targetBottomIndex])
        )
      }
    }
  }
...
export const flattenDeepToKey = (
  ...
  const recursionFn = (
    data: TreeNodeType[],
    deep: any,
    stuckFlag: string[] | undefined = undefined
  ) => {
