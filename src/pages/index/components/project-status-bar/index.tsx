...
const ProjectStatusBar: React.FC<Props> = (props) => {
  ...
  const { data: projectStatus } = useRequest(
    () =>
      getProjectStatus({ areaCode: currentAreaInfo.areaId, areaType: currentAreaInfo.areaLevel }),
    {
  ...
  return <>{option && <BarChart options={option} />}</>
}
