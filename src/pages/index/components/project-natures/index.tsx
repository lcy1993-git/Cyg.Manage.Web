...
const ProjectNatures: React.FC<Props> = (props) => {
  ...
  const { data: projectNatures } = useRequest(
    () =>
      getProjectNatures({ areaCode: currentAreaInfo.areaId, areaType: currentAreaInfo.areaLevel }),
    {
  ...
  return option ? <BarChart options={option} /> : null
}
