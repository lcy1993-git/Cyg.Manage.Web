...
const ChartBoxLine: React.FC<ChartBoxLineProps> = (props) => {
      ...
      if (context) {
        ...
        if (align === 'center') {
          ...
          if (tltleWidthLevel === 'normal') {
            firstLineX = canvas.width * 0.01
            secondLineX = canvas.width * 0.19
            threeLineX = canvas.width * 0.2
            ...
            firstLineX = canvas.width * 0.01
            secondLineX = canvas.width * 0.39
            threeLineX = canvas.width * 0.4
            fourLineX = canvas.width
  ...
  return <canvas ref={divRef} width={width} height={7}></canvas>
}
