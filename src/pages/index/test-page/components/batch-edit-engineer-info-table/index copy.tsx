...
const BatchEditEngineerInfoTable: React.FC = () => {
    ...
    return (
        <div className={styles.batchEditEngineerInfoTable}>
            ...
            <div>
                <Button onClick={() => handleFinallyData()}>测试</Button>
            </div>
        </div>
    )
}
