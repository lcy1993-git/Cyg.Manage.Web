...
export const GetMaterialLibraryById = (id: string) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/GetMaterialLibraryById`, {
      method: 'POST',
      data: { id },
    })
  )
...
export const createMaterialLibrary = (params: MaterialLibrary) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/CreateMaterialLibrary`, {
      method: 'POST',
      data: params,
    })
  )
...
export const deleteMaterialLibrary = (id: string) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/DeleteMaterialLibrary`, {
      method: 'POST',
      data: { id },
    })
  )
...
export const importSourceMaterials = (id: string) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/ImportSourceMaterials`, {
      method: 'POST',
      data: { id },
    })
  )
...
export const getSourceMaterialLibrary = (province: string) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/GetSourceMaterialLibrary`, {
      method: 'POST',
      data: { province },
    })
  )
...
export const GetSourceMaterialLibraryCatalogue = (libId: string) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/GetSourceMaterialLibraryCatalogue`, {
      method: 'POST',
      data: { libId },
    })
  )
...
export const getSourceMaterialItems = (params: GetSourceMaterialItems) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/GetSourceMaterialItems`, {
      method: 'POST',
      data: params,
    })
  )
...
export const searchSourceMaterialItems = (params: SearchSourceMaterialItems) => {
  return cyRequest(() =>
    request(`${baseUrl.tecEco}/SourceMaterial/SearchSourceMaterialItems`, {
      method: 'POST',
      data: params,
    })
  )
