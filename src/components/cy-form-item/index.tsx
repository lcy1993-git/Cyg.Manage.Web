...
const withCyFormItemProps = <P extends {}>(WrapperComponent: React.ComponentType<P>) => (props: P & CyFormItemProps & {children ?: React.ReactNode}) => {
    const { className = "",labelWidth = 80, label = "",align = "left",required, ...rest} = props;
    ...
    return (
        <div className={`${styles.cyFormItem} ${className}`}>
            <div className={`${styles.cyFormItemLabel} ${lableAlign}`} style={{width: `${labelWidth}px`}}>
