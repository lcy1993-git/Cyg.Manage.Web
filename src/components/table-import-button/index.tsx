...
const TableImportButton: React.FC<TableImportButtonProps> = (props) => {
    const { importUrl = "",accept, modalTitle = "导入",labelTitle = "导入",name = "file", extraParams, ...rest } = props;
    ...
    return (
        <div>
            ...
            <Modal
                ...
                <Form form={form}>
                    <CyFormItem label={labelTitle} name="file" required rules={[{validator: checkHasUploadFile}]}>
